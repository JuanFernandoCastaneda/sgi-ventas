...
BACKEND_IP="http://localhost:8000" gnome-terminal --tab -- bash -c "cd ventas-front/ && pnpm dev; exec bash" # En teoría no debería cerrar la terminal pero imagino que como utilizó cd lo hace.
